const skillButtons: string[] = [
    ...
    '恐怖付与', '恐怖無効化', '強要', '共和国の灰', '切り返し', 'クールダウン減少', 'クールダウン増加付与', 'クールダウン増加無効化', 'クールダウン状態から開始', 'クールダウンリセット', '苦悩', '起爆トラップ', '狂気の刃',
    ...
    '賞金稼ぎの決意', '触発', 'ショック', '信頼できるエージェント', 'スキルブロック付与', 'スキルブロック無効化', 'スタン付与', 'スタン無効化', 'スタンス - クロスガード', 'スタンス - ダブルブレード', 'スタンス - デュアルブレード',
    'ステルス', 'ステルス解除', 'スピード上昇', 'スピード低下', '精度低下', '精度上昇', '憎悪', '即戦闘不能', '即戦闘不能耐性', 'セカンドウィンド', '全体攻撃', '潜伏',
    'ダーク・インフュージョン', 'ターゲットロック', 'ターンメーター入れ替え', 'ターンメーター減少付与', 'ターンメーター減少無効化', 'ターンメーター上昇', 'チーワプ社製医療パック', '知略', 'チャージ', '挑発付与', '挑発無効化',
