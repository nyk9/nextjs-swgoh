...
import { useShipFilter } from "@/features/shiplist/hooks/useShipFilter";
...
function ResultGrid({
  ...
  totalCount: number;
  results: import("@/types/ships/ships").Ship[];
}) {
  return (
    <section>
...
function ShipCard({ ship }: { ship: import("@/types/ships/ships").Ship }) {
  return (
