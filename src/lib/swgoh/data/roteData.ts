...
import platoonsRaw from "./rote-platoons.json";
import specialMissionsRaw from "./rote-restricted-missions.json";
...
/**
 * RotE TB 小隊データの全フェーズを返す
 * プロンプト生成で小隊達成状況をフォーマットする際に使用
 */
export function getPlatoonPhases(): RotePlatoonsData["phases"] {
  return (platoonsRaw as unknown as RotePlatoonsData).phases;
}
