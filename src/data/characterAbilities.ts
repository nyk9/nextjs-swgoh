...
const characterAbilities: CharacterAbilities[] = [
  ...
  },
  {
    ...
    ability: [
      ...
      },
      {
        ...
        image:
          "/abilityui/tex.abilityui_passive_singletrooperaerialplatform.png",
  ...
  {
    id: "Omega-S3",
    character_name: "オメガ(逃亡者)",
    character_image: "/charui/tex.charui_omegas3.png",
    ability: [
      {
        ability_type: "通常スキル",
        name_jp: "エネルギー・クロスボウ",
        name_eng: "Energy Crossbow",
        image: "/ability/tex.ability_omegas3_basic.png",
        description_jp: `ターゲットに**特殊ダメージ**を与える。味方バッド・バッチが**人質**状態の場合、**救出目標**を5得る。そうでない場合、**ステルス**状態ではない最も悪いコンディションの味方バッド・バッチに2ターンの**クリティカル回避力上昇**が発生する。`,
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        name_jp: "ビッグ・シスター",
        name_eng: "Big Sister",
        image: "/ability/tex.ability_omegas3_special01.png",
        description_jp: `バッド・バッチの味方全体の**弱体化効果**を全て**解除**する。指定した味方の**プロテクション**が100%**回復**し、さらにオメガのリリップアンプレベルごとに**プロテクション**が15%**回復**する。この効果は**解除**した**弱体化効果**ごとに5%減少する。その味方の**プロテクション**が100%**回復**の間、**プロテクション**が1**回復**するごとに、HPが1%**回復**する。その味方のHPが100%の間、HPが20%**回復**するごとに、**クールダウン**が1減少する。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        cooldown: 3,
        name_jp: "逃げ道",
        name_eng: "Escape Route",
        image: "/ability/tex.ability_omegas3_special02.png",
        description_jp: `最も良いコンディションの味方バッド・バッチから**ステルス効果**が**解除**され、遭遇終了まで、その他バッド・バッチの味方全体が**ステルス効果**を得る（コピー、解除、阻止不可）。敵に**ステルス**状態の場合、代わりに**ターンメーター**が10%上昇し、オメガのリリップアンプレベルごとにさらに**ターンメーター**が5%上昇する。バッド・バッチの味方全体が、2ターンの間、**報復**、**切り返し**、**抵抗力上昇**を得る。**ステルス**状態の味方全体が、2ターンの間、**アドバンテージ**、**フォアサイト**、**スピード上昇**を得る。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },{
        ability_type: "リーダースキル",
        name_jp: "見て学ぶ",
        name_eng: "Learn by Seeing",
        image: "/abilityui/tex.abilityui_leader_default.png",
        description_jp: `味方バッド・バッチのターン中、味方バッド・バッチがその前の味方バッド・バッチのターンでダメージを受けたのと同じ量にダメージを与える。退避終了またはダメージを受けた際にアクティブな間に別の敵にダメージを与えない限り、バッド・バッチの味方全体に**射撃訓練**のスタックが発生する。
                
                $グランドアリーナでは銀河の伝説が存在せず、味方全体がバッド・バッチの場合$：味方がエクスポーズまたはボーナスプロテクションを持つ敵からダメージを受けると、味方全体の**射撃訓練**のスタックを獲得し、敵全体が最大HP1%分のダメージを受ける（**回避不可**）。このダメージでは敵を戦闘不能にできない。**ステルス**状態の味方は**時間経過ダメージ**を無効化し、倒れた敵は**復活**できる。**スタン**状態になると別の味方のHPが100%を下回るたび**ボーナスターン**を得る。`,
        is_omega: true,
        is_zeta: false,
        is_omicron: true,
      },
      {
        ...
        name_jp: "おかしなクローン",
        name_eng: "Odd Clone",
        image: "/abilityui/tex.abilityui_passive_clonetrooper.png",
        description_jp: `オメガ(逃亡者)の**スピード**が50上昇する。
                
                オメガ(逃亡者)がリーダーのスロットにいる場合、各味方オメガ(逃亡者)、バッチャー、ハンター(傭兵)、レッカー(隊長)、クロスへアー(探偵)が初めて**戦闘不能**になると次の効果が発生する：**スキル効果**と**弱体化効果**を全て**解除**し、バトル終了まで10スタックの「**人質**」が発生する。人質状態の間は**ターゲットにされない**。**ダメージ**・**回復**・**強化効果**。**弱体化効果**を全て**無効化**し、味方バッド・バッチがターンを開始するたび、人質のスタックを1失う。人質目標が達成された場合、人質状態が**解除**され、HPとプロテクションが100%**回復**する。そうでない場合、即座に**戦闘不能**になる。この効果は戦闘不能後も持続する。
                *人質*：スピードが0に設定され、ボーナスアタックやボーナスターンを獲得できなくなる。
                *救出目標*：射撃訓練のスタックを30得る。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
    ...
    last_updated: "2024年6月28日",
  },
  {
    id: "Wrecker-S3",
    character_name: "レッカー(傭兵)",
    character_image: "/charui/tex.charui_wreckers3.png",
    ability: [
      {
        ability_type: "通常スキル",
        name_jp: "強烈な一撃",
        name_eng: "Forceful Blow",
        image: "/ability/tex.ability_wreckers3_basic.png",
        description_jp: `ターゲットの**強化効果**を2つ**解除**し、**物理ダメージ**を2回与える。レッカーのターン中、ターゲットから**解除**された**強化効果**ごとに**ターンメーター**を5%減少させる。バッド・バッチの味方全体の**ターンメーター**が10%上昇する。`,
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        cooldown: 3,
        name_jp: "渾身の一撃",
        name_eng: "Mighty Blow",
        image: "/ability/tex.ability_wreckers3_special01.png",
        description_jp: `ターゲットに**物理ダメージ**を与え、2ターンの**よろめき**を発生させる。レッカー(傭兵)が**戦闘不能**になるまで**武装解除**状態にし、その他全て（コピー、解除、阻止不可）を奪う。ターゲットが既に**武装解除**状態の場合、このスキルで与える**ダメージ**が50%増加する（レイドボスと銀河の伝説を除く）。レッカーの**雇われ兵**のスタックが30を超えている場合、レッカーと最も弱っている味方バッド・バッチの**ターンメーター**が50%上昇する。2ターンの**挑発**を行う。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        cooldown: 6,
        name_jp: "即席武器",
        name_eng: "Improvised Weapon",
        image: "/ability/tex.ability_wreckers3_special02.png",
        description_jp: `敵全体に**物理ダメージ**を与え、2ターンの**よろめき**を発生させる。味方バッド・バッチの**弱体化効果**を全て**解除**する。味方の**防御力低下**、**スピード低下**、**抵抗力低下**が**解除**された場合、その**弱体化効果**と反対の**強化効果**が2ターン発生する。このスキルを使用するたび、バトル終了までレッカー(傭兵)の**防御力**、**最大HP**、最大**プロテクション**が25%上昇する（スタック可能、最大100%）。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ability_type: "ユニークスキル",
        name_jp: "前に出なきゃ勝てないぞ",
        name_eng: "Can't Win If You Don't Go First",
        image: "/abilityui/tex.abilityui_passive_yougottabeinfronttowin.png",
        description_jp: `味方バッド・バッチの**抵抗力**が75%上昇する。各遭遇開始時、レッカーは2ターンの**挑発**を行う。敵がターン外に攻撃するたび、味方バッド・バッチのHPとプロテクションが5%**回復**する。味方バッド・バッチは**回復無効**状態になるたび、その効果を**解除**し、HPとプロテクションが25**回復**する。また、2ターンの**防御力上昇**を得る。味方バッド・バッチが**ターン**を開始する前に敵が50%以上の**ボーナス**ターンメーターを得るたび、味方バッド・バッチ全員の**ターンメーター**が15%上昇する。別の味方バッド・バッチが**人質**状態になると、「即席武器」の**クールダウン**が**リセット**され、レッカーが2ターンの**挑発**を行う（コピー、解除、阻止不可）。他の味方バッド・バッチが**人質**状態の間、レッカーの**最大HP**と**プロテクション**が25%上昇する。テリトリーバトルの場合、味方バッド・バッチの**最大HP**と最大**プロテクション**が100%上昇し、**攻撃力**が50%上昇する。レッカーがアクティブな間、既に**人質**が使用された後に味方バッド・バッチが**戦闘不能**になった場合、その味方はHPとプロテクションが100%の状態で**復活**し、2ターンの間**ステルス**状態になる。この効果はユニット1体につき1回のみ発生する。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: true,
      },
      {
        ...
        name_jp: "雇われ兵",
        name_eng: "Hired Gun",
        image: "/abilityui/tex.abilityui_passive_soldieroffortune.png",
        description_jp: `バトル開始時、レッカー(傭兵)は自身のレリックアンプレベルごとに**雇われ兵**のスタックを1得る。味方バッド・バッチまたは傭兵が**クリティカルヒット**を受けるたび、レッカーは**雇われ兵**のスタックを3得る。レッカーは**弱体化効果**を受けるたび、**雇われ兵**のスタックを5失う。ターン開始時、傭兵の味方全体は次のターン開始まで保有している**雇われ兵**のスタックごとに**防御力**が5%（スタック可能）、**抵抗力**が1%（スタック可能）上昇する。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
  ...
  {
    id: "Crosshair-S3",
    character_name: "クロスヘア(偽跡)",
    character_image: "/charui/tex.charui_crosshair_scarred.png",
    ability: [
      {
        ability_type: "通常スキル",
        name_jp: "ヒットカミか",
        name_eng: "Hit or Miss",
        image: "/ability/tex.ability_crosshair_basic.png",
        description_jp: `ターゲットに**物理ダメージ**を3回与え、2ターンの**防御力低下**を発生させます（**回避**、**耐性発揮**不可）。この攻撃が外れた場合、2ターンの間ターゲットを**エクスポーズ**状態にします（**回避**、**耐性発揮**不可）。`,
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        name_jp: "穏やか",
        name_eng: "Calm",
        image: "/ability/tex.ability_crosshair_special01.png",
        description_jp: `ターゲットに**物理ダメージ**を与え、クロスヘア(偽跡)のレリックアンプレベルに応じて10%の**増加ダメージ**を与えます。指定した味方バッド・バッチを**アシスト**に呼び、50%の**増加ダメージ**を与えます。指定した味方かクロスヘア(偽跡)が指定した場合、クロスヘアは**アシスト**を行いますが、代わりに自身の**シェイク**のスタックを6取り除き、ターゲットを1ターンの間**スタン**状態にします。リーダー・スロットの味方がオメガ（逃亡者）で、前のターンに味方バッド・バッチの攻撃により**ダメージ**を受けた場合、「標的を捕捉」の**クールダウン**が減少します。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        cooldown: 8,
        name_jp: "標的を捕捉",
        name_eng: "Target Acquired",
        image: "/ability/tex.ability_crosshair_special02.png",
        description_jp: `ターゲットに**物理ダメージ**を与え、遭遇終了まで**アーマー破壊**を発生させます（銀河の伝説とレイドボスを除く）。このスキル「標的を捕捉」が再び使用されるまでの敵とクロスヘア(偽跡)の**ターン**数に応じて、この攻撃で与える**ダメージ**が50%増加します（最大50%）。この攻撃は**回避**できます。またクロスヘア(偽跡)が**シェイク**状態の場合、使用できません。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        name_jp: "頭のなか",
        name_eng: "In My Head",
        image: "/abilityui/tex.abilityui_passive_itsinmyhead.png",
        description_jp: `バトル開始時、クロスヘア(偽跡)の防御力が3ターン200%上昇し、シェイクのスタックが20発生します（コピー、解除、**回避**、**耐性発揮**不可）。
                
                クロスヘア(偽跡)は射撃訓練のスタックを得るたび、ターンメーターが15%上昇します。
                
                **シェイク**のスタックが全て取り除かれるたび、クロスヘア(偽跡)は自身の**弱体化効果**を全て**解除**し、**ボーナスターン**を得ます。
                
                マーク状態の敵をターゲット中、クロスヘア(偽跡)の**精度**が50%上昇します。
                
                銀河の伝説がいない場合、クロスヘア(偽跡)は**プロテクションを無効化**します。
                
                グランドアリーナで、銀河の伝説がいない場合、クロスヘア(偽跡)は**弱体化効果**を受けるたび、それを**解除**して、1ターンの**弱攻撃力**が5%上昇します（スタック可能、最大100%）。
                
                射撃訓練を持っている味方バッド・バッチが**特殊スキル**を使用するたび、クロスヘア(偽跡)が**アシスト**を行います。
                
                *シェイク*: スタックごとに精度-10%を付与します。この効果は戦闘不能後も持続します。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: true,
      },
  ...
  {
    id: "Batcher",
    character_name: "バッチャー",
    character_image: "/charui/tex.charui_batcher.png",
    ability: [
      {
        ability_type: "通常スキル",
        name_jp: "クラッシュアサルト",
        name_eng: "Crush Assault",
        image: "/ability/tex.ability_batchers3_basic.png",
        description_jp: `ターゲットに**物理ダメージ**を与え、1ターンの**スピード上昇**を得る。バッチャーのターン中、**無力マーク**状態の場合、1ターンの間、**防御力低下**と**バランス崩壊**のスタックが2発生する。`,
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        cooldown: 2,
        name_jp: "ヒアリングハウル",
        name_eng: "Hearing Howl",
        image: "/ability/tex.ability_batchers3_special01.png",
        description_jp: `バッド・バッチの味方全体の**攻撃力**が2ターンの間30%上昇し、ターゲットの**強化効果**を全て**解除**する（**耐性発揮不可**）。2ターンの間**マーク**状態にする（**耐性発揮不可**）。**バランス崩壊**状態の敵全体に1ターンの**スキルブロック**を発生させ、2ターンの**攻撃力低下**を発生させる。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        cooldown: 3,
        name_jp: "フェロジャスバイト",
        name_eng: "Ferocious Bite",
        image: "/ability/tex.ability_batchers3_special02.png",
        description_jp: `ターゲットに**物理ダメージ**を与え、2ターンの間**固定状態**にして、遭遇終了まで、**出血**のスタックを2発生させる(最大6、解除不可)。**出血**: **スピード**と**抵抗力**が5%低下し、ターン毎にHPを5%失う。HPが回復するとスタックが減少する。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        name_jp: "LH-201",
        name_eng: "LH-201",
        image: "/abilityui/tex.abilityui_passive_lh201.png",
        description_jp: `バッチャーの**ダメージ**は**回避**できます。またターン中、バッチャーは**ステルス**と**挑発**を無効化する。他の味方バッド・バッチが人間状態の場合、バッチャーの**攻撃力**が50%上昇し、**スピード**が50上昇し、「ヒアリングハウル」の**クールダウン**が1減少する。バッチャーはターン中に特殊スキルを使用するたび、自身を**アシスト**する。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
  ...
  {
    id: "Hunter-S3",
    character_name: "ハンター(傭兵)",
    character_image: "/charui/tex.charui_hunters3.png",
    ability: [
      {
        ability_type: "通常スキル",
        name_jp: "DC-17ブラスター",
        name_eng: "DC-17 Blaster",
        image: "/ability/tex.ability_hunters3_basic.png",
        description_jp: `ターゲットに**物理ダメージ**を与え、1ターンの**スピード低下**を発生させる。ハンターのターン中、ランダムな味方バッド・バッチアタッカーを**アシスト**に呼び、アタッカーの味方全体が1ターンの**クリティカル率上昇**を得る。ターゲットが**マーク**状態の場合、バッド・バッチアタッカーの味方全体の**攻撃力**が通常終了まで(5%上昇し(5スタック可能、最大50%)、通過終了まで**防御力**が5%減少する(5スタック可能、最大50%))。**耐性発揮不可**。`,
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        name_jp: "狙え",
        name_eng: "Take Aim",
        image: "/ability/tex.ability_hunters3_special01.png",
        description_jp: `**マーク**状態の敵がいない場合、ターゲットに2ターンの**マーク**を発生させる(**回避不可**)。バッド・バッチの味方全体が1ターンの**攻撃力上昇**と**プロテクション上昇**(50%)を得る。バッド・バッチアタッカーの味方全体を**アシスト**に呼び、30%の**減少ダメージ**を与える。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        cooldown: 3,
        name_jp: "こいつは痛ぇぞ",
        name_eng: "This Is Gonna Hurt",
        image: "/ability/tex.ability_hunters3_special02.png",
        description_jp: `ターゲットに最大HP100%分の**物理ダメージ**を与え、敵が**マーク**状態の場合は200%に増加する(**回避不可**)。敵全体を2ターンの間**ショック**状態にする(**回避不可**)にし、ターゲットに3ターンの**プロテクション破壊**を発生させる(回避、**耐性発揮不可**)。遭遇終了まで、味方バッド・バッチの**防御突破力**が100%上昇する(スタック可能)。このスキルは**クールダウン状態から開始**。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ability_type: "ユニークスキル",
        name_jp: "連携特化",
        name_eng: "Coordinated Efforts",
        image: "/abilityui/tex.abilityui_passive_focusedcooperation.png",
        description_jp: `遭遇開始時、バッド・バッチの味方全体の**最大プロテクション**が50%上昇する。敵が**マーク**状態になると、バッド・バッチの味方全体が1ターンの間**防御力**が50%回復する。**マーク**状態の敵が味方バッド・バッチからダメージを受けるたび、**ターンメーター**が最も低い味方バッド・バッチの味方は1ターンの間、**スピード上昇**を得る。敵に発生している**マーク**の効果が切れるたび、その敵に1ターンの**めまい効果**と1ターンの**回復無効**を発生させる。**マーク**状態の敵のターン開始時、1ターンの**攻撃力低下**を発生させる(**回避不可**)。**マーク**状態の敵が戦闘不能になるたび、敵全体を2ターンの間**エクスポーズ**状態にする(**回避不可**)。敵の**マーク**が切れ、**ハンター**は**ホーカストーン**のスタックを得る。ハンターに**射撃訓練**のスタックが15以上ある場合、敵の**マーク**が切れるとハンターは**ホーカストーン**のスタックを得る。ハンターが**射撃訓練**のスタックを得るたび、「こいつは痛ぇぞ」の**クールダウン**が減少する。味方バッド・バッチが**人間状態**の場合、味方バッド・バッチはターン中にターゲットに**追加でダメージ**を与える。ハンターに**雇われ兵**のスタックが40以上ある間、敵の1ターンの**強化無効**が発生する。味方バッド・バッチが**人質**を失うと、「こいつは痛ぇぞ」の**クールダウン**が**リセット**される。
        
        $テリトリーウォーズの場合$：遭遇開始時、ハンターの「こいつは痛ぇぞ」が利用可能になる。ハンターが**射撃訓練**のスタックを得ると「こいつは痛ぇぞ」の**クールダウン**が5減少する。銀河の伝説がいない場合、味方バッド・バッチの味方全体が**追加でダメージ**を与える(**回避不可**)。**マーク**状態の敵がターンを開始するたび、遭遇終了までの敵の**最大HP**が10%減少する(スタック可)。銀河の伝説を除く。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: true,
      },
      {
        ...
        name_eng: "Hired Gun",
        image: "/abilityui/tex.abilityui_passive_soldieroffortune.png",
        description_jp: `味方**傭兵**が**マーク**状態の敵にダメージを与えるたび、ハンターは**雇われ兵**のスタックを1得る。**雇われマーク**が解除または効果が切れるたび、ハンターは**雇われ兵**のスタックを5失う。各味方**傭兵**はターン開始時、保有している**雇われ兵**のスタックごとに次のターン開始まで**精度**が3%上昇する。`,
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
    ...
    ability: [
      {
        ...
        description_jp:
          "ターゲットに物理ダメージを与え、75%の確率でランダムな味方1体に2ターンの間フォアサイトを発生させる(フォアサイトが発生していない味方のみが対象)。味方全員が強化を得ている場合、ダメージが2倍になる。",
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        description_jp:
          "味方全体の弱体化効果を全て無効化し、2ターンの間、逆の強化効果を発生させる。弱体化効果の発生していなかった味方は3ターンの報復効果が発生する。ケノービ将軍のターンメーターが60%上昇する。",
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        description_jp:
          "ターゲットに物理ダメージを与え、ランダムな味方1体に2ターンの攻撃力上昇を付与する。強化効果が発生しているすべての味方をアシストに呼び、30%の低下ダメージを与える。ジェダイ・ナイト・アナキンとアソーカ・タノはこれによるダメージペナルティを受けない。",
        is_omega: true,
        is_zeta: false,
        is_omicron: false,
      },
      {
        ...
        image: "/abilityui/tex.abilityui_passive_hp.png",
        description_jp:
          "味方ジェダイおよびクローンの最大HPが30%、防御力が70%上昇する。味方ジェダイが全体回復の特殊スキルを使用すると、HPが最大値の味方全員がアシストを行う。アシスト時の攻撃はダメージが50%減少する。味方クローンは特殊スキルを使用すると1ターンの強化(アタッカー: アドバンテージ、サポート: ステルス、タンク: 挑発)が発生する",
        is_omega: false,
        is_zeta: false,
        is_omicron: false,
      },
  ...
  },
  {
    ...
    ability: [
      ...
      },
      {
        ...
        description_jp:
          "ターゲットに物理ダメージを与え、ターゲットがダークサイドの場合、1ターンのスキルブロックを発生させる(銀河の伝説を覗く)。防御突破力上昇が発生していない最弱の味方ライトサイドに2ターンの防御突破力上昇が発生する。ジェダイ・マスター・ケノービのターン中にこのスキルを使用すると、アルティメットチャージが9%上昇する。",
        is_omega: true,
        is_zeta: true,
        is_omicron: false,
      },
      {
        ...
        description_jp:
          "ターゲットに物理ダメージを与え、2ターンの無防備と回復効果を発生させる(解除、耐性発揮不可)。指定した味方ライトサイドをアシストに呼び、50%の増加ダメージを与える。ジェダイ・マスター・ケノービが選択された場合、ケノービはアシストを行わない代わりに、アルティメットチャージが12%上昇し(リーダーである場合はその2倍)、次のこのスキル使用時に50%の増加ダメージを与える(スタック可能、最大10スタック)。",
        is_omega: true,
        is_zeta: true,
        is_omicron: true,
      },
