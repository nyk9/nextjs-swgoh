...
const characters: Characters[] = [
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、第501軍団、クローン・トルーパー、銀河共和国",
  ...
  },
  {
    ...
    abbreviation:
      "Admiral Ackbar admiral ackbar AA ギアル・アクバー It's a trap",
    skill: [
      "ターンメーター上昇付与",
      "弱体解除",
      "味方全体-弱体解除",
  ...
  },
  {
    ...
    skill: ["ターンメーター減少付与", "アシスト", "ターンメーター上昇付与"],
  ...
  {
    name: "エズラ・ブリッジャー(流浪)",
    character_base_id: "EZRAEXILE",
    property: "ライトサイド、サポート、ジェダイ、スペクター",
    src: "/charui/tex.charui_ezraexile.png",
    abbreviation: "Ezra Bridger",
    skill: [
      "スピード低下",
      "フォアサイト",
      "よろめき",
    ...
    url: "/characters/Ezra-Bridger-Exile",
  },
  {
    name: "エンフィス・ネスト",
  ...
  },
  {
    ...
    abbreviation:
      "OB ob Obi-Wan Kenobi (Old Ben) Obi Wan obi wan obi-wan Hello There ベン・ケノービ Ben ben ",
    skill: [
      "回避力低下",
      "有効性上昇",
      "回避不可",
  ...
  },
  {
    ...
    name: "オメガ（逃亡者）",
    character_base_id: "OMEGAS3",
    property: "ライトサイド、サポート、逃亡者、リーダー、バッド・バッチ、フォーダー、賞金稼ぎ",
    src: "/charui/tex.charui_omegas3.png",
    abbreviation: "Omega omega 逃亡者",
    skill: [
      "エクスポーズ",
      "ボーナスプロテクション",
      "射撃訓練",
    ...
    url: "/characters/Omega-S3",
  },
  {
    name: "レッカー(傭兵)",
    character_base_id: "WRECKERS3",
    property: "ライトサイド、タンク、バッド・バッチ、傭兵、オーダー66、レイド",
    src: "/charui/tex.charui_wreckers3.png",
    abbreviation: "Wrecker Mercenary レッカー 傭兵",
    skill: [
      "強化解除",
      "ターンメーター減少付与",
      "ターンメーター上昇付与",
    ...
    url: "/characters/Wrecker-S3",
  },
  {
    name: "クロスヘア(偽跡)",
    character_base_id: "CROSSHAIRS3",
    property: "ライトサイド、アタッカー、バッド・バッチ、オーダー66、レイド",
    src: "/charui/tex.charui_crosshair_scarred.png",
    abbreviation: "Crosshair Imposter クロスヘア 偽跡",
    skill: [
      "防御力低下",
      "エクスポーズ",
      "回避不可",
    ...
    url: "/characters/Crosshair-Imposter",
  },
  {
    name: "バッチャー",
    character_base_id: "BATCHERS3",
    property: "ライトサイド、アタッカー、バッド・バッチ、オーダー66、レイド",
    src: "/charui/tex.charui_batcher.png",
    abbreviation: "Batcher バッチャー",
    skill: [
      "スピード上昇",
      "防御力低下",
      "攻撃力上昇",
    ...
    url: "/characters/Batcher",
  },
  {
    name: "ハンター(傭兵)",
    character_base_id: "HUNTERS3",
    property: "ライトサイド、サポート、バッド・バッチ、傭兵、オーダー66、レイド",
    src: "/charui/tex.charui_hunters3.png",
    abbreviation: "Hunter Mercenary ハンター 傭兵",
    skill: [
      "スピード低下",
      "アシスト",
      "クリティカル率上昇",
  ...
  },
  {
    ...
    property:
      "銀河の伝説、ダークサイド、アタッカー、リーダー、ファースト・オーダー、非同盟のフォースの使い手",
    src: "/charui/tex.charui_kyloren_tros.png",
    abbreviation:
      "SLKR slkr GL Galactic Legends galactic legends Supreme Leader Kylo Ren supreme leader kylo ren",
    skill: [
      "強化無効",
      "アドバンテージ",
      "サイフォン",
  ...
  },
  {
    ...
    abbreviation:
      "KAM kam Ki- Adi-Mundi Ki Adi Mundi ki-adi-mundi ki adi mundi",
    skill: [
      "アタル・フォーム",
      "マカシ・フォーム",
      "ターンメーター上昇付与",
  ...
  },
  {
    ...
    property:
      "ダークサイド、サポート、リーダー、賞金稼ぎ、ハット・カルテル、ならず者",
  ...
  {
    name: "キャプテン・イノック",
    character_base_id: "CAPTAINENOCH",
    property: "ダークサイド、サポート、リーダー、インペリアル・レムナント",
    src: "/charui/tex.charui_captainenoch.png",
    abbreviation: "Captain Enok captain enok",
    skill: [
      "クールダウン減少付与",
      "弱体解除",
      "プロテクション上昇",
  ...
  },
  {
    ...
    abbreviation:
      "Captain Han Solo captain han solo Hoth hoth ホスハン CHOLO CHS cholo chs",
    skill: [
      "めまい付与",
      "ターンメーター上昇付与",
      "弱体解除",
  ...
  },
  {
    ...
    property:
      "ライトサイド、サポート、クローン・トルーパー、フェニックス、反乱軍、反乱軍ファイター",
  ...
  },
  {
    ...
    property:
      "ダークサイド、アタッカー、リーダー、ドロイド、分離主義者、艦隊司令官",
    src: "/charui/tex.charui_grievous.png",
    abbreviation:
      "GG General Grievous general grievous gg ゴキブリーヴァス将軍 容赦なき前進",
    skill: [
      "回復無効",
      "回避不可",
      "カウンター不可",
  ...
  },
  {
    ...
    property:
      "ダークサイド、タンク、リーダー、賞金稼ぎ、ハット・カルテル、ならず者、ウーキー",
  ...
  {
    name: "グレート・マザー",
    character_base_id: "GREATMOTHERS",
    property: "ダークサイド、サポート、リーダー、ナイトシスター",
    src: "/charui/tex.charui_greatmothers.png",
    abbreviation: "Great Mothers",
    skill: [
      "スキルブロック付与",
      "スピード低下",
      "ステルス",
  ...
  },
  {
    ...
    abbreviation:
      "Clone Sergent - Phase Ⅰ I クローンサージェント クローン サージェント",
    skill: [
      "ターンメーター上昇付与",
      "全体攻撃",
      "ターンメーター減少付与",
  ...
  },
  {
    ...
    skill: ["スタン付与", "攻撃力低下", "全体攻撃", "ターンメーター上昇付与"],
  ...
  },
  {
    ...
    property:
      "ライトサイド、サポート、リーダー、ならず者、非同盟のフォースの使い手",
  ...
  },
  {
    ...
    abbreviation:
      "JKCK JKC jkck jkc Jedi Knight Cal Kestis jedi knight cal kestis",
    skill: [
      "強化解除",
      "ボーナスターン",
      "挑発無視",
  ...
  },
  {
    ...
    abbreviation:
      "JKL jkl Jedi Knight Luke Skywalker jedi knight kuke skywalker",
    skill: [
      "強化解除",
      "固定ダメージ",
      "最大プロテクション上昇",
  ...
  },
  {
    ...
    property:
      "銀河の伝説、ライトサイド、アタッカー、リーダー、銀河共和国、ジェダイ",
    src: "/charui/tex.charui_globiwan.png",
    abbreviation:
      "JMK jmk Jedi Master Kenobi jedi master kenobi GL Hello There",
    skill: [
      "スキルブロック付与",
      "防御突破力上昇",
      "無防備",
  ...
  },
  {
    ...
    abbreviation:
      "JML jml Jedi Master Luke Skywalker jedi master luke skywalker",
    skill: [
      "強化無効",
      "最大HP上昇",
      "カウンター不可",
  ...
  },
  {
    ...
    abbreviation:
      "GBA gba Geonosian Brood Alpha geo Geo geonosian brood alpha 蟲",
    skill: [
      "強化解除",
      "全体攻撃",
      "エクスポーズ",
  ...
  },
  {
    ...
    property:
      "銀河の伝説、ダークサイド、サポート、リーダー、賞金稼ぎ、ハット・カルテル、スマグラー",
  ...
  },
  {
    ...
    skill: ["スピード低下", "全体攻撃", "スタン付与", "ターンメーター上昇付与"],
    url: "/characters/Jawa",
  },
  {
    name: "ジャワ・エンジニア",
  ...
  },
  {
    ...
    property:
      "ダークサイド、アタッカー、リーダー、賞金稼ぎ、マンダロリアン、ならず者、分離主義者",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、リーダー、反乱軍、反乱軍ファイター、ローグ・ワン",
  ...
  {
    name: "シン・ハティ",
    character_base_id: "SHINHATI",
    property: "ダークサイド、アタッカー、傭兵、非同盟のフォースの使い手",
    src: "/charui/tex.charui_shinhati.png",
    abbreviation: "Shin Hati",
    skill: [
      "クリティカル率減少",
      "雇われ兵",
      "アシスト",
  ...
  },
  {
    ...
    abbreviation:
      "GAS gas General Anakin Skywalker general anakin skywalker スカぴょん",
    skill: [
      "回避不可",
      "防御突破力上昇",
      "アーマー破壊",
  ...
  },
  {
    ...
    property:
      "ダークサイド、サポート、帝国軍、インペリアル・レムナント、帝国軍トルーパー",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、ハット・カルテル、ならず者、スマグラー",
  ...
  },
  {
    ...
    abbreviation:
      "SK sk Starkiller sterkiller ギャレン・マレック Galen Marek galen marek",
    skill: [
      "ショック",
      "全体攻撃",
      "カウンター不可",
  ...
  },
  {
    ...
    property:
      "ダークサイド、タンク、帝国軍、インペリアル、レムナント、帝国軍トルーパー",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、レジスタンス、ならず者、ウーキー、スマグラー",
    src: "/charui/tex.charui_tfa_chewbacca.png",
    abbreviation:
      "Vets Veteran Smuggler Chewbacca Chew vets veteran smuggler chewbacca",
    skill: [
      "めまい付与",
      "スタン付与",
      "スピード低下",
  ...
  },
  {
    ...
    abbreviation:
      "Vets vets veteran smuggler han solo Veteran Smuggler Han Solo",
    skill: [
      "よろめき",
      "スタン付与",
      "スキルブロック付与",
  ...
  },
  {
    ...
    property:
      "ダークサイド、ヒーラー、リーダー、帝国軍、尋問官、非同盟のフォースの使い手",
  ...
  },
  {
    ...
    skill: ["時間経過ダメージ", "攻撃力上昇", "回復", "ターンメーター上昇付与"],
  ...
  {
    name: "デス・トルーパー(ぺリディア)",
    character_base_id: "DEATHTROOPERPERIDIEA",
    property: [
      "ダークサイド",
      "アタッカー",
      "インペリアル・レムナント",
    ...
    src: "/charui/tex.charui_deathtrooperperidea.png",
    abbreviation: "Death Trooper Peridea",
    skill: [
      "攻撃力上昇",
      "クリティカル率上昇",
      "サイフォン",
    ...
    url: "/characters/Death-Trooper-Peridea",
  },
  {
    name: "テック",
  ...
  },
  {
    ...
    abbreviation:
      "9s 9S Ninth Sister ninth sister マサナ・タイド Masana Tide masana ",
    skill: [
      "粛清",
      "耐性発揮不可",
      "時間経過ダメージ",
  ...
  },
  {
    ...
    property:
      "ダークサイド、サポート、リーダー、ファースト・オーダー、艦隊司令官",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、リーダー、バッド・バッチ、クローン・トルーパー",
  ...
  },
  {
    ...
    property:
      "ダークサイド、サポート、リーダー、帝国軍、帝国軍トルーパー、艦隊司令官",
  ...
  },
  {
    ...
    abbreviation:
      "First Order Executioner first order executioner FOE foe FOX fox",
    skill: [
      "最大HP上昇",
      "アドバンテージ",
      "ターンメーター減少付与",
  ...
  },
  {
    ...
    abbreviation:
      "First Order SF TIE Pilot first order sf tie pilot special force",
    skill: [
      "防御力低下",
      "アドバンテージ",
      "全体攻撃",
  ...
  },
  {
    ...
    property:
      "ダークサイド、サポート、リーダー、帝国軍、尋問官、非同盟のフォースの使い手",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、リーダー、賞金稼ぎ、ハット・カルテル、ならず者",
  ...
  },
  {
    ...
    abbreviation:
      "大名 Daimyo BFSoJ SOJ SoJ soj bfsoj Boba Fett, Scion of Jango boba fett scion jango  ﾌｪｯ!!",
    skill: [
      "モメンタム",
      "解除不可",
      "阻止不可",
  ...
  },
  {
    ...
    abbreviation:
      "MJ mj Mara Jade, The Empeor's Hand mara jade the emprors hand",
    skill: [
      "めまい付与",
      "アシスト",
      "全体攻撃",
  ...
  },
  {
    ...
    abbreviation:
      "BAM bam The Mandalorian (Beskar Armor) the mandalorian beskar armor",
    skill: [
      "時間経過ダメージ",
      "ホイッスリング・バード",
      "アシスト不可",
  ...
  {
    name: "モーガン・エルズベス",
    character_base_id: "MORGANELSBETH",
    property: ["ダークサイド", "タンク", "ナイトシスター"],
    src: "/charui/tex.charui_morganelsbeth.png",
    abbreviation: "Morgan Elsbeth",
    skill: [
      "防御力上昇",
      "プロテクション上昇",
      "ステルス",
  ...
  },
  {
    ...
    property:
      "ダークサイド、タンク、リーダー、帝国軍、インペリアル・レムナント",
    src: "/charui/tex.charui_moffgideons3.png",
    abbreviation:
      "Dark Trooper Moff Gideon dark trooper moff gideon Long Live the Empire DTMG",
    skill: [
      "洞察",
      "めまい付与",
      "攻撃力低下",
  ...
  },
  {
    ...
    property:
      "ライトサイド、サポート、リーダー、反乱軍、ローグ・ワン、艦隊司令官",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、リーダー、反乱軍、反乱軍ファイター、ならず者",
    src: "/charui/tex.charui_landobespin.png",
    abbreviation:
      "Lando Calrissian lando calrissian ランド・カルリジアンからのお別れの挨拶",
    skill: [
      "クールダウンリセット",
      "全体攻撃",
      "リーダー：スピード上昇",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、リーダー、反乱軍、非同盟のフォースの使い手",
  ...
  },
  {
    ...
    property:
      "銀河の伝説、ライトサイド、アタッカー、リーダー、レジスタンス、非同盟のフォースの使い手",
  ...
  },
  {
    ...
    property:
      "ライトサイド、タンク、リーダー、レジスタンス、非同盟のフォースの使い手",
    src: "/charui/tex.charui_rey_tlj.png",
    abbreviation:
      "RJT JTR 修行中レイ rjt jtr Rey(Jedi Trainig) rey jedi training",
    skill: [
      "回復無効",
      "コピー不可",
      "解除不可",
  ...
  },
  {
    ...
    property:
      "ライトサイド、アタッカー、レジスタンス、非同盟のフォースの使い手",
  ...
  },
  {
    ...
    abbreviation:
      "GL GLレイア gl Geractic Legends garactic legends Leia Organa leia organa",
    skill: [
      "報復効果",
      "固定ダメージ",
      "強化解除",
  ...
  },
  {
    ...
    skill: ["ターンメーター上昇付与", "エクスポーズ", "フォアサイト"],
  ...
  },
  {
    ...
    property:
      "ライトサイド、タンク、バッド・バッチ、クローン・トルーパー、銀河共和国",
