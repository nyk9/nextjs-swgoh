    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-1 bg-neutral-700">
      <div className="mt-5 md:mt-0 grid center text-center w-full md:w-2xl md:grid-cols-3 xl:grid-cols-4  lg:w-full lg:mb-0 lg:text-left">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>swgoh.gg</p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>キャラ一覧</p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>ソースコード</p>
        </Link>
      </div>
      ...
      <div>
        <Link href="/privacy-policy" className="text-center mt-2">
          プライバシーポリシー・免責事項
        </Link>
      </div>
    </main>
