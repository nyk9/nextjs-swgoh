...
const characters: Characters[] = [
    {
        ...
        skill: `スタン付与  回復  強化解除  敵全体-強化解除  ターンメーター減少  クールダウンリセット
        ...
        skill: `防御力低下  スタン付与  スキルブロック  リーダー：防御力上昇  `
    }, {
        name: "イウォーク・エルダー",
        ...
        skill: `ステルス  挑発  有効性上昇  スタン付与  ターンメーター減少  クリティカル率上昇
        ...
        skill: `抵抗力低下  挑発  スタン付与  回復  回避不可  リーダー：クリティカルダメージ上昇
        ...
        skill: `強化無効  アドバンテージ  サイフォン  スタン付与  マスター上昇  リーダー：スピード上昇
            リーダー：クリティカルダメージ上昇  挑発  ターンメーター上昇  復活不可 全体攻撃  スタン無効化`
    }, {
        name: "ガ―モリアン・ガード",
        ...
        skill: `めまい  よろめき  スタン付与  ターンメーター上昇  プロテクション上昇  報復効果
            抵抗力上昇  回復`
    }, {
        name: "カル・ケスティス",
        ...
        skill: `精度低下  ターンメーター上昇  強化解除  スタン付与  ターンメーター減少  最大プロテクション低下
        ...
        skill: `弱体解除  スタン付与  回復  クールダウンリセット  抵抗力低下  めまい  全体攻撃
        ...
        skill: `有効性低下  ターンメーター上昇  攻撃力上昇  防御突破力上昇  全体攻撃  ターンメーター減少
        ...
        skill: `有効性上昇  ターンメーター減少  全体攻撃  クリティカル率減少  攻撃力低下  ターンメーター上昇
        ...
        skill: `回復無効  回避不可  カウンター不可  ターゲットロック  ターンメーター減少  ヘルススティール上昇
        ...
        skill: `有効性上昇  サーマル・デトネーター  ターンメーター上昇  クリティカル率上昇  ターンメーター減少
            ターンメーター上昇  スタン付与  強化解除  リーダー：クリティカルダメージ上昇  カウンター`,
    }, {
        name: "グリーフ・カルガ",
        property: "ライトサイド、サポート、リーダー、賞金稼ぎ、ならず者",
        src: greefkarga,
        abbreviation: "Greef Karga greef karga",
        skill: `めまい  回復  強化解除  アシスト  攻撃力上昇  防御突破力上昇  クリティカルダメージ上昇  クリティカル率上昇
        ...
        skill: `抵抗力低下  よろめき  全体攻撃  復活  アシスト  スタン付与  スキルブロック  強化無効  スピード低下
        ...
        skill: `ターンメーター上昇  全体攻撃  ターンメーター減少  クリティカル率上昇  攻撃力上昇`
    }, {
        name: "クローン大戦チューバッカ",
        property: "ライトサイド、タンク、リーダー、銀河共和国、ならず者、ウーキー",
        src: clonechewy,
        abbreviation: "Clone Wars Chewbacca チューイ clone wars chewbacca CWC cwc",
        skill: `ターンメーター減少  挑発  最大HP上昇  弱体解除  回復  防御力上昇  ターンメーター上昇   リーダー：防御力上昇`
    }, {
        name: "クワイ=ガン・ジン",
        property: "ライトサイド、サポート、リーダー、銀河共和国、ジェダイ",
        src: qgj,
        abbreviation: "QGJ qgj Gui-Gon Jinn gui gon jinn",
        skill: `ターンメーター上昇  ターンメーター減少  アシスト  回復  強化解除  攻撃力上昇  リーダー：スピード上昇  リーダー：攻撃力上昇
            フォアサイト `
    }, {
        name: "ケイナン・ジャラス",
        ...
        skill: `攻撃力低下  挑発  弱体解除  抵抗力上昇  味方全体-弱体解除  防御力上昇  フォアサイト  プロテクション上昇  ターンメーター上昇  カウンター  回復`
    }, {
        name: "ケノービ将軍",
        ...
        skill: `無防備  回復  弱体解除  クリティカル率上昇  ステルス  アシスト  全体攻撃  抵抗力低下  よろめき  リーダー：防御力上昇  リーダー：最大HP上昇  リーダー：最大プロテクション上昇
            ターンメーター上昇  プロテクション上昇  リーダー：クリティカルダメージ上昇  ターゲットロック  クールダウン減少  挑発  抵抗力上昇  強化解除  敵全体-強化解除  回復無効
            カウンター  疑惑  `
    }, {
        name: "サビーヌ・レン",
        ...
        skill: `欺瞞  コピー不可  解除不可  耐性発揮不可  スピード上昇  カウンター不可  アシスト  回復  復活不可  報復効果  挑発  連帯  ボーナスターン
            ...
            エクスポーズ  HP割合ダメージ軽減  大ダメージ軽減  スタン無効化`
    }, {
        name: "シス・トルーパー",
        ...
        skill: `アシスト  プロテクション上昇  暗闇  回復  弱体解除  味方全体-弱体解除  スピード低下  用心棒  クリティカルヒット耐性  防御突破力上昇
            ...
            即戦闘不能  固定ダメージ  カウンター不可  回避不可  スタン無効化`
    }, {
        name: "ジャワ",
        ...
        skill: `弱体解除  挑発  スタン付与  回避不可  回復  全体攻撃  ステルス  よろめき  カウンター  攻撃力上昇  ヘルススティール上昇  救済  アシスト
            ターンメーター上昇`
    }, {
        name: "ショアトルーパー",
        ...
        skill: `ショック  全体攻撃  カウンター不可  クールダウン減少  めまい  無防備  フォースエネルギー  回避不可  強化無効  回復無効  耐性発揮不可  味方全体-弱体解除
            コピー不可  解除不可  強化解除  敵全体-強化解除  カウンター  恐怖無効化  解放  弱体解除  ボーナスターン  クールダウンリセット  スタン付与  挑発  アシスト
            クリティカルヒット耐性  ダメージ耐性  挑発  スタン無効化`
    }, {
        name: "スターク大佐",
        ...
        skill: `めまい  スタン付与  スピード低下  ターンメーター上昇  クールダウンリセット  ボーナスターン  `
    }, {
        name: "スマグラー・ハン",
        property: "ライトサイド・アタッカー、レジスタンス、ならず者、スマグラー",
        src: smugglerhan,
        abbreviation: "Vets vets veteran smuggler han solo Veteran Smuggler Han Solo",
        skill: `よろめき  スタン付与  スキルブロック  ターンメーター上昇  クールダウンリセット  ボーナスターン  `
    }, {
        name: "スローン大提督",
        property: "ダークサイド、サポート、リーダー、帝国軍、艦隊司令官",
        src: thrawn,
        abbreviation: "GAT gat Grand Admiral Thrawn grand admiral thrawn",
        skill: `スピード上昇  スキルブロック  スタン付与  耐性発揮不可  防御力低下  強化解除  ターンメーター減少  破砕  ターンメーター交換  回復  弱体解除  ターンメーター上昇
            カウンター  `
    }, {
        name: "セカンド・シスター",
        property: "ダークサイド、アタッカー、リーダー、帝国軍、尋問官、非同盟のフォースの使い手",
        ...
        skill: `粛清  耐性発揮不可  クリティカルダメージ上昇  スタン付与  ターンメーター減少  ターンメーター上昇  マーク  回避不可  ターンメーター上昇`
    }, {
        name: "セブンス・シスター",
        ...
        skill: `防御力低下  クールダウン減少  ターンメーター減少  攻撃力減少  回避不可  耐性発揮不可  強化解除  敵全体-強化解除  回復  暗闇  リーダー：最大HP上昇
            ...
            攻撃力上昇  挑発  ターンメーター上昇  起爆トラップ  コピー不可  解除不可  クリティカルダメージ低下  スタン付与  炎上  よろめき  ボーナスターン
        ...
        skill: `ステルス  回避不可  強化解除  回復  弱体解除  ターンメーター上昇  挑発  プロテクション上昇  アシスト  エクスポーズ  回復無効  スタン付与  耐性発揮不可
        ...
        skill: `ステルス  スキルブロック  スタン付与  防御力低下  ターンメーター減少  `
    }, {
        name: "ダッシュ・レイダー",
        property: "ライトサイド、サポート、リーダー、ならず者",
        src: dash,
        abbreviation: "Dash Rendar dash rander",
        skill: `アシスト  強化解除  スタン付与  全体攻撃  ステルス解除  めまい  防御力低下  クリティカルダメージ低下
        ...
        skill: `狂気の刃  コピー不可  解除不可  阻止不可  カウンター不可  切り返し  ボーナスターン
            溢れる狂気  クールダウンリセット  全体攻撃  無防備  スタン付与  耐性発揮不可  クールダウン増加  強化無効
        ...
        skill: `めまい  スタン付与  全体攻撃  強化解除  敵全体-強化解除  回復無効  クールダウン増加  耐性発揮不可
        ...
        skill: `アシスト  スピード低下  スタン付与  抵抗力低下  時間経過ダメージ  ステルス  ターンメーター減少  サーマル・デトネーター
        ...
        skill: `スタン付与  スキルブロック  カウンター不可  回避不可  ショック  スタン付与  切り返し  ステルス  弱体解除
        ...
        skill: `ショック  スタン付与  時間経過回復  時間経過プロテクション  スキルブロック  解除不可  耐性発揮不可
        ...
        skill: `スピード低下  ターンメーター減少  ターンメーター上昇  強化解除  スタン付与  フォアサイト  アーマー無効化`
    }, {
        name: "ナイトシスター・ゾンビ",
        ...
        skill: `スキルブロック  弱体解除  攻撃力上昇  防御力上昇  スピード上昇  精度上昇  クリティカル率上昇  アシスト
            強化解除  スタン付与  強化無効  プロテクション上昇  ターンメーター上昇  挑発  回復  伝説の戦闘瞑想  解除不可
            アドバンテージ  報復効果`
    }, {
        ...
        skill: `ターンメーター減少  回避不可  スタン付与  ターンメーター上昇  クリティカル率上昇  回避力上昇  クリティカルダメージ上昇  ボーナスターン
            挑発無効化`
    }, {
        name: "ハンター",
        ...
        skill: `粛清  耐性発揮不可  強化解除  全体攻撃  防御力低下  エクスポーズ  有効性上昇  無防備  プロテクション上昇  ダメージ耐性
            スタン付与  恐怖  コピー不可  解除不可  回避不可  リーダー：防御力上昇  リーダー：最大HP上昇  スピード減少  エクスポーズ
        ...
        skill: `回復  アドバンテージ  防御力上昇  挑発  決意  報復効果  エクスポーズ  スタン付与  リーダー：防御力上昇  リーダー：攻撃力上昇
        ...
        skill: `ボーナスターンメーター上昇無効化  攻撃力上昇  有効性低下  弱体解除  味方全体-弱体解除  アシスト  スピード低下  クリティカル率上昇
            回復  スタン付与  ターンメーター減少  クリティカルダメージ上昇  時間経過ダメージ  固定ダメージ  アシスト  報復効果  フォアサイト
        ...
        skill: `固定ダメージ  回避不可  強化解除  スピード上昇  アーマー破壊  クールダウン減少  弱体解除  味方全体-弱体解除  アシスト
            ...
            挑発  復活  HP割合ダメージ軽減  回復  めまい無効化  挑発無効化  スタン付与`
    }, {
        name: "ボ＝カターン・クライズ",
        ...
        skill: `スタン付与  アシスト  クールダウン減少  弱体解除  回復  フレンジー  挑発  攻撃力上昇  リーダー：最大プロテクション上昇  リーダー：抵抗力上昇`
    }, {
        name: "ホス反乱軍スカウト",
        property: "ライトサイド、アタッカー、反乱軍、反乱軍ファイター",
        src: hothscout,
        ...
        skill: `めまい  アシスト 全体攻撃  強化解除  スタン付与  無防備  抵抗力低下  攻撃力低下  ショック  よろめき  ステルス  ターンメーター上昇
        ...
        skill: `スキルブロック  ターンメーター上昇  回復  強化解除  スタン付与  ターンメーター減少  アシスト   ターンメーター入れ替え
        ...
        skill: `洞察  めまい  攻撃力低下  よろめき  スタン付与  ターンメーター減少  固定ダメージ  回復無効  解除不可  耐性発揮不可
        ...
        skill: `スピード低下  防御力低下  ターンメーター減少  スタン付与  強化解除  強化無効  抵抗力低下  クールダウン減少
        ...
        skill: `無防備  めまい  よろめき  時間経過ダメージ  スタン付与  強化解除  回避不可  プロテクション減少  触発`
    }, {
        name: "レッカー",
        property: "ライトサイド、タンク、バッド・バッチ、クローン・トルーパー、銀河共和国",
        src: wrecker,
        abbreviation: "Wrecker wrecker Bad Batch bad batch BB bb",
        skill: `スピード低下  回復  逆上  ステルス解除  ターンメーター上昇  挑発  防御力上昇  抵抗力上昇  スタン付与  全体攻撃
            怒り  コピー不可  解除不可  阻止不可`
    }, {
        name: "レンジ・トルーパー",
        property: "ダークサイド、サポート、帝国軍、帝国軍トルーパー",
        ...
        skill: `スピード低下  スタン付与  防御力上昇  時間経過回復  HP上昇  報復効果  挑発  回復  `
    }, {
        name: "ローズ・ティコ",
        property: "ライトサイド、アタッカー、レジスタンス",
        src: rose,
        abbreviation: "Rose Tico rose tico",
        skill: `抵抗力上昇  防御力上昇  ターンメーター上昇  ターンメーター減少  回避不可  スタン付与  めまい  耐性発揮不可`
    }, {
        name: "ログレイ",
        ...
        skill: `時間経過ダメージ  スタン付与  ターンメーター上昇  回避不可  全体攻撃  弱体解除  めまい  プロテクション上昇  解除不可  阻止不可
