...
export default function Character(
    ...
    const skillButtons: string[] = [
        ...
        '攻撃力低下', '攻撃力上昇', '感染', '有効性上昇', '有効性減少', 'プロテクション上昇', '粛清', 'ターンメーター減少', 'クールダウン減少', 'クールダウン増加', '復活', '復活不可', '切り返し', 'クールダウンリセット', 'クールダウン状態から開始',
        ...
        '賞金稼ぎの決意', '救済', '帝国の罠', '潜伏', '信頼できるエージェント', 'フォースエネルギー', '解放', '破砕', '起爆トラップ', 'ロイヤルハンド', '無慈悲', '無慈悲な標的', 'ダーク・インフュージョン', '帰ってきたぞ', '溢れる狂気', '狂気の刃', 'ガード',
